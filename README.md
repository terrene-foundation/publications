# Terrene Foundation White Paper Series

Open publications from the [Terrene Foundation](https://terrene.foundation) — a Singapore Company Limited by Guarantee that publishes open standards for enterprise AI governance.
...
All papers are published under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). You may share, adapt, and build upon this work for any purpose, including commercially, with attribution.

## Author

Dr. Jack Hong, Singapore Management University

## Citation

When citing these papers, please use the following format:

```
Hong, J. (2026). "[Paper Title]." White Paper Series, Version [X.Y]. Terrene Foundation.
...
- [care](https://github.com/terrene-foundation/care) — CARE Platform (Apache 2.0)
